<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Formulir Data Identitas Pasien</li>
  </ol>
</section>
    ...
    <div class="box-body">
      ...
      <div class="col-md-12">
        <div class="box box-primary box-solid">
          ...
          <form action="<?php echo base_url(); ?>update-identitas-pasien" method="post" class="form-horizontal">
            {identitas}
            <input type="hidden" name="id_kk" value="<?php echo $id_kk['data']['id_kk']; ?>">
            <div class="box-body">
              <div class="form-group">
                <label for="input-kk-no-bpjs" class="col-sm-3 control-label">No. BPJS</label>

                <div class="col-md-3">
                  <input type="text" class="form-control" minlength="13" maxlength="13" size="13" name="no_bpjs" readonly required value="{no_bpjs}" id="input-kk-no-bpjs">
              ...
              <div class="form-group">
                ...
                <div class="col-md-5">
                  <input type="text" class="form-control" name="nama" value="{nama}" id="input-kk-nama" required>
              ...
              <div class="form-group">
                ...
                <div class="col-md-2">
                  <input type="hidden" id="jq-jenis-kelamin" value="{jenis_kelamin}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-3 date">
                  <input type="date" name="tgl_lahir" value="{tgl_lahir}" class="form-control" min="<?php $mintime =  strtotime("-100 year"); echo date('Y-m-d', $mintime); ?>" max="<?php echo date('Y-m-d'); ?>" required>
              ...
              <div class="form-group">
                ...
                <div class="col-md-3">
                  <input type="text" class="form-control" name="suku_bangsa" value="{suku_bangsa}" id="input-kk-suku-bangsa" required>
              ...
              <div class="form-group">
                ...
                <div class="col-md-2">
                  <input type="hidden" id="jq-agama" value="{agama}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-3">
                  <input type="hidden" id="jq-pendidikan-terakhir" value="{pendidikan_terakhir}">
                  <select name="pendidikan_terakhir" id="input-kk-pendidikan-terakhir" class="form-control" required>
                    <option value="" selected disabled>Pilih Opsi</option>
              ...
              <div class="form-group">
                ...
                <div class="col-md-2">
                  <input type="hidden" id="jq-kelas-bpjs" value="{kelas_bpjs}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-2">
                  <input type="hidden" id="jq-status-tagihan-bpjs" value="{status_tagihan_bpjs}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-2">
                  <input type="hidden" id="jq-hidup" value="{hidup}">
...
<script type="text/javascript">
  $(document).ready(function(){
    $('[name=jenis_kelamin]').val($('#jq-jenis-kelamin').val()).attr('selected', 'selected');
    $('[name=agama]').val($('#jq-agama').val()).attr('selected', 'selected');
    $('[name=pendidikan_terakhir]').val($('#jq-pendidikan-terakhir').val()).attr('selected', 'selected');
    $('[name=kelas_bpjs]').val($('#jq-kelas-bpjs').val()).attr('selected', 'selected');
    $('[name=status_tagihan_bpjs]').val($('#jq-status-tagihan-bpjs').val()).attr('selected', 'selected');
    $('[name=hidup]').val($('#jq-hidup').val()).attr('selected', 'selected');
  });
</script>