            ...
            <form role="form" action="" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <input type="text" name="penyakit[]" id="penyakit" class="form-control" value="<?php echo set_value('penyakit[]'); echo $diagnosis_penyakit['data'][$key]['penyakit']; ?>">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <input type="text" name="terapi[]" id="terapi" class="form-control" value="<?php echo set_value('terapi[]'); echo $diagnosis_penyakit['data'][$key]['terapi']; ?>">
              ...
              <div id="pemicu-risiko" class="box box-solid box-primary">
                ...
                <div class="box-body">
                  ...
                  <?php foreach ($faktor_risiko['data'] as $key => $value): ?>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="faktor-risiko" class="control-label">Faktor Risiko Penyakit</label>
                        <input type="text" name="faktor_risiko[]" id="faktor-risiko" class="form-control" value="<?php echo $value['faktor_risiko'] ?>">
                        <span class="help-block"><small>&nbsp;</small></span>
                      </div>
                      <div class="form-group">
                        <label for="faktor-pemicu" class="control-label">Faktor Pemicu Penyakit</label>
                        <input type="text" name="faktor_pemicu[]" id="faktor-pemicu" class="form-control" value="<?php echo $faktor_pemicu['data'][$key]['faktor_pemicu'] ?>">
                        <span class="help-block"><small>&nbsp;</small></span>
                      </div>
                    </div>
                    <div class="col-md-6">
