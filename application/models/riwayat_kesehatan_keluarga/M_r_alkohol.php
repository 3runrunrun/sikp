...
class M_r_alkohol extends CI_Model
{
  ...
  {
    $nilai = array();
    $sql = 'UPDATE kk_r_alkohol SET durasi = ? WHERE id_kk = ? AND id_alkohol = ? AND id_riwayat_kes_kel = ? AND no_bpjs = ?';
  ...
  {
    $nilai = array();
    $sql = 'UPDATE kk_r_alkohol SET hapus = \'1\' WHERE id_kk = ? AND id_alkohol = ? AND id_riwayat_kes_kel = ? AND no_bpjs = ?';
    echo $sql;
