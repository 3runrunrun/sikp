$(function(){
  $('#add-riw-3-bulan').click(function(){
    ...
    var element = '<div class="row" style="margin-bottom:10px !important">' +
      '<div class="col-md-4">' +
        '<select name="tb_no_bpjs[]" class="form-control select2-single" tabindex="-1" required>' +
          namelist +
        '</select>' +
      '</div>' +
      '<div class="col-md-7">' +
        '<input type="text" name="tb_jenis_penyakit[]" class="form-control" placeholder="penyakit atau kecelakaan yang pernah dialami" required>' +
      '</div>' +
      '<div class="col-md-1">' +
